...
String.prototype.matchRequirsive = function(start:string,end:string):null|Array<string>{
	var search = this;
...
function Lss(code : string,variables={}){
    interface LssPart{
        selector: string
        children: Array<LssPart>
        code:string
    }
    ...
    function Divide(code:string) : LssPart {
        let data : LssPart = { selector:"",children:[] , code:""}
        var mat = null;
        /**
         * **;** character index
         */
    ...
    function JoinTag(selector:string) {
    ...
    function Join(data : LssPart, tag:string = "", superScript:string="") {
    ...
    function JoinNormal(data:LssPart) {
        var totalCSS="";
        for (let i = 0; i < data.children.length; i++) {
            const element = data.children[i];
...
Lss.Multi = function(codes:string[]):string[]{
    var variables = {};
...
Lss.Webkit = function (code:string): string {
