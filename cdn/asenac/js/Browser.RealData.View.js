var Asenac;
(function (Asenac) {
    let BrowserViewRealData;
    (function (BrowserViewRealData) {
        BrowserViewRealData.complie = function (page, ...datas) {
        ...
        let CrelObjs = [];
        function Complie(code, datagram) {
        ...
        function ComplieSingle(jsonAsena, datagram) {
            if (jsonAsena.type.type == "Crel") {
                ...
                EvalVariablesInner(jsonAsena.type.eval, datagram).evaled;
            }
                ...
                if (idElement == null)
                    idElement = IdList[jsonAsena.type.replace];
                if (idElement) {
                    idElement.empty();
        ...
        function CreateElement(params, datagram) {
        ...
        function UpdateElement(element, params, datagram) {
            let param = params.crel;
            if (param.id != "" && param.id != null)
                element.setAttribute("id", param.id);
            if (param.className != "" && param.className != null)
        ...
        function CreateText(param, datagram) {
        ...
        function If(jsonAsena, datagram) {
                    ...
                    if (element.type.type == "If" || element.type.type == "ElseIf") {
                        ...
                        if (if_bool_2) {
                            if (condution !== i) {
                                ...
                                parent.empty();
                                parent.appendChild(Complie(element.children, datagram));
                            }
                            condution = i;
                            return;
                        }
        ...
        function For(jsonAsena, datagram) {
            ...
            let parentNode = document.createDocumentFragment();
            if (forParent != null)
        ...
        function Goto(jsonAsena, datagram) {
            if (jsonAsena.type.type == "Goto") {
                if (jsonAsena.type.goto in Asenac.PagesJson) {
                    ...
                    let code = Asenac.PagesJson[evalPage.evaled];
        ...
        function RemoveTriggers(el, startMe = true) {
         ...
         */
        function EvalVariablesOuter(___script, datagram) {
            let ___D = datagram.data, // First Data
            ___G = datagram.datas, // Globals
            ___FK = datagram.keys, ___LFK = datagram.lastKey;
            var mat;
         ...
         * @param ___LFK -> Last Foreach Key
         */
        function EvalVariablesInner(___script, datagram) {
            let ___D = datagram.data, ___G = datagram.datas, ___FK = datagram.keys, ___LFK = datagram.lastKey;
         ...
         *
         */
    })(BrowserViewRealData = Asenac.BrowserViewRealData || (Asenac.BrowserViewRealData = {}));
})(Asenac || (Asenac = {}));
